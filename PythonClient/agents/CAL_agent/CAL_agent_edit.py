...
class CAL(Agent):
    ...
    def reset_state(self):
        ...
        self._state = VehicleState()
    def modified_run_step(self, measurements, sensor_data, carla_direction, target):
        ...
        with open("/home/self-driving/Desktop/CARLA_0.8.2/Indranil/CAL-master/PythonClient/_benchmarks_results/latestData.csv","a+") as myf:
    ...
    def run_step(self, measurements, sensor_data, carla_direction, target):
        ...
        with open("/home/self-driving/Desktop/CARLA_0.8.2/Indranil/latestData.csv","a+") as myf:
            wrs=str(self._state.center_distance_GT)+","+str(self._state.long_accel)+","+str(self._state.lat_accel)+","+\
                str(measurements.game_timestamp)+","+str(self._state.direction)
            myf.write(wrs+"\n")
        ...
        if self._state.image_hist is None:
            ...
            print("1 works")
            self._state.image_hist = im0.repeat_interleave(self._seq_len,dim=1)
            print("2 works")
        else:
